  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: 40 }}>
      <div style={{ background: '#fff', borderRadius: 8, padding: 32, maxWidth: 420, width: '100%', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
        ...
        <p style={{ color: '#888', marginBottom: 24, fontSize: 14 }}>Sign in to manage your Streamlit apps</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', marginBottom: 4, fontWeight: 600, fontSize: 14 }}>User ID or Email</label>
            <input name="userId" required placeholder="myuser or email@example.com" style={{ width: '100%', padding: '10px 12px', border: '1px solid #ddd', borderRadius: 6, fontSize: 14 }} />
          </div>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', marginBottom: 4, fontWeight: 600, fontSize: 14 }}>Password</label>
            <input type="password" name="password" required placeholder="Enter your password" style={{ width: '100%', padding: '10px 12px', border: '1px solid #ddd', borderRadius: 6, fontSize: 14 }} />
          </div>
