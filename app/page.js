...
export default function Home() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: 40 }}>
      <div style={{ background: '#fff', borderRadius: 8, padding: 40, maxWidth: 500, width: '100%', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: 8 }}>Streamlit Auto-Refresher</h1>
        <p style={{ color: '#888', marginBottom: 32, fontSize: 15, lineHeight: 1.5 }}>
        ...
        <ul style={{ textAlign: 'left', margin: '24px 0', padding: 0, listStyle: 'none' }}>
          {['Register your Streamlit app URLs', 'Refresh all your apps with one click or API call', 'Multi-user support with MongoDB', 'CLI tool for command-prompt automation'].map((text, i) => (
            <li key={i} style={{ padding: '6px 0', fontSize: 14, color: '#555' }}>
